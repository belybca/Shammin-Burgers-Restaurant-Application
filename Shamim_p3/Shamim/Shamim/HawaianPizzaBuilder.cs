...
namespace Shamim
{
    ...
    public class HawaianPizzaBuilder : IHawaianPizzaBuilder, IAddition1HP, IAddition2HP, IAddition3HP
    {
        ...
        public HawaianPizzaBuilder(string baseDough, string sauce, string cheese, double price)
        {
            hp = new BasicPizza(baseDough, sauce, cheese, price);
           
        }

        public static IHawaianPizzaBuilder Init(string baseDough, string sauce, string cheese, double price)
        {
            return new HawaianPizzaBuilder(baseDough, sauce, cheese, price);
        }
